            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                   ...
                   <li class="menu-item-has-children dropdown" >
                       <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-address-card"></i>Resort Details</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="admin_add_resort.php">Add Resort Details</a></li>
                            <li><i class="menu-icon fa fa-file-image-o"></i><a href="admin_add_images.php">Add Images</a></li>
                        <li><i class="menu-icon fa fa-bath"></i><a href="admin_add_rooms.php">Add Room Types</a></li>
						<li><i class="menu-icon fa fa-tasks"></i><a href="admin_resort_view.php">View Resorts</a></li>
						</ul>
                    </li>
                    <li >
