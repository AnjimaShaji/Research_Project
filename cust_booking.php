...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<script>
			<!--//function calc(){ -->
			 ...
			 function calc(){
   var textValue1 = document.getElementById('txt_Amount1').value;
...
<body>
 ...
 <div class="row form-group">
                                                               <div class="col col-md-3"><label for="hf-email" class=" form-control-label"><b>Check in</b></label></div>
                                                                <div class="col-12 col-md-9"><input type="date" class='fromdate form-control' name="cn" placeholder="Enter check in date..."  min="<?php $date= date("Y-m-d",strtotime("+0 day"));echo $date;?>" required></div>
                                                            </div>
 <div class="row form-group">
                                                                <div class="col col-md-3"><label for="hf-password" class=" form-control-label"><b>Check out</b></label></div>
                                                                <div class="col-12 col-md-9"><input type="date" class='todate form-control' name="co" placeholder="Enter check out date..."  min="<?php $date= date("Y-m-d",strtotime("+1 day"));echo $date;?>" required></div>
                                                            </div>
															<div class="row form-group">
															...
															<div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9"><input type="number" class="txt_Amount form-control" name="txt_Amount" id="txt_Amount"   value="<?php echo $row2['rm_package']; ?>" onclick='showDays()'></div>
                                                           </div>
														   <div class="row form-group">
                                                                <div class="col col-md-3"><label for="hf-password" class=" form-control-label"><b>Total</b></label></div>
                                                                <div class="col-12 col-md-9"><input type="number" class="txt_Amount1 form-control"  name="txt_Amount1" id="txt_Amount1" onclick='showDays()'   ></div>
                                                           </div>
