            ...
            <div class="panel panel-info">
                <div class="panel-body">
                    ...
                    <textarea class="pb-cmnt-textarea" required placeholder="Write your comment here.." name='sent_data' id='sent_data'></textarea>
                        ...
                        <?php
include ('Research/lib/sentiment_analyser.class.php');
...
$words = array('good', 'nice', 'excellent', 'clean','XXXXXXXXXXXXXXXX'); 
 //Add more words here
...
function loadDoc() {
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      document.getElementById("reviewid").innerHTML = this.responseText;
    }
  };
  xhttp.open("GET", "search.php?name=rooms", true);
  xhttp.send();
}
...
<form action="userfeedback_action.php" method="post" enctype="multipart/form-data" onsubmit="return Validate()" style="margin-top: 20px;">-->
 ...
 <a href="?uid=<?php echo $kid;?>&name=resort#gr" name="resort" >Resort</a>
<BR><BR>
