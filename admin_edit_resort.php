...
$kid=$_SESSION['h_id'];
$res=mysqli_query($con,"SELECT * FROM tbl_addresort where h_id='$kid'");
			...
			<div class="inner" >
				<form action="admin_resort_action.php" method="post" enctype="multipart/form-data" onsubmit="return Validate()" style="margin-top: 20px;">
					...
					<div class="form-holder">
						...
						<input type="text" name="rname" id="rname" value ="<?php echo $row['r_name'];?>"class="form-control" placeholder="Resort Name" required onchange="Validate();">
						</div>
...
document.getElementById('msg1').innerHTML=" ";
    return true;
						...
						<select name="class" value ="<?php echo $row['r_star'];?>"style="border-style: initial;padding-top: 18px; padding-bottom: 10px; margin-bottom: 4px;width: 100%; border-bottom: 1px solid #e6e6e6;" Required>&nbsp &nbsp
					...
					<input type="text" name="radd" value ="<?php echo $row['r_address'];?>"id="radd" class="form-control" placeholder="Resort Address" required onchange="Validname();">
					</div>
...
document.getElementById('msg3').innerHTML=" ";
    return true;
					...
					<div class="form-holder">
					<span class="lnr lnr-apartment"></span>
					<select name="state" class="tkvsoft"value ="<?php echo $row['s_id'];?>" style="border-style: initial;padding-top: -18px; padding-bottom: 10px; margin-bottom: 4px;width: 100%; border-bottom: 1px solid #e6e6e6;"required>
					...
					<select name="dis_name" class="tkvsoft1" value ="<?php echo $row['d_id'];?>"style="border-style: initial;padding-top: -18px; padding-bottom: 10px; margin-bottom: 4px;width: 100%; border-bottom: 1px solid #e6e6e6;"required>
