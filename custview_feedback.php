...
<br><br><br><br><br><br><br><br><br><br><h1><font color="green"><center>FEEDBACKS</h1></font>
<?php
include 'dbconnect.php';
$res1=mysqli_query($con,"SELECT * FROM `tbl_feedback` where f_status=1");
...
<?php
	...
	$a=$_SESSION['r_id'];
	$res=mysqli_query($con,"SELECT * FROM `tbl_feedback` WHERE `r_id`='$a' and f_status='1'");
	$i=1;
...
<td><center><a href="feedback_edit.php?uid=<?php echo $row['f_id'];?>"><img src="images/edit.ico" width="30px"></a></td>
<td><center><a href="feeback_del.php?uid=<?php echo $row['f_id'];?>"><img src="images/DeleteRed.png" width="30px"></a></td></tr>
...
<a href="feedback.php?uid=<?php echo $_SESSION['r_id'];?>">Back</a>
