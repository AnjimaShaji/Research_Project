...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<body>
		<div class="wrapper" style="background-image:url('images/bg-01.jpg');">
			<div class="inner" >
				<form action="admin_resort_action.php" method="post" enctype="multipart/form-data" onsubmit="return Validate()" style="margin-top: 203px;">
					<h3>New Resort??</h3>
					<div class="form-holder">
						<span class="lnr lnr-user"></span>
						<input type="text" name="rnme" id="rnme" class="form-control" placeholder="Resort Name" required onchange="Validate();">
					</div>

					<div class="form-holder">
						<span class="lnr lnr-apartment"></span>
						<input type="text" name="radd" id="radd" class="form-control" placeholder="Address" required onchange="Validname();">
					</div>
					...
					<div class="form-holder">
						...
						<input type="text" name="url" id="url" class="form-control" placeholder="Site url" required onchange="return Validata();">
					</div>
					<div class="form-holder">
						<span class="lnr lnr-envelope"></span>
						<input type="email" name="email" id="email" class="form-control" placeholder="Email" required onchange="return Validata();">
					</div>
					<div class="form-holder">
