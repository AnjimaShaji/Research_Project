		...
		<div class="home_slider_container">
			...
			<div class="owl-carousel owl-theme home_slider">
				...
				<div class="owl-item home_slider_item">
					...
					<div class="home_slider_background" style="background-image:url(images/bg-01.jpg)"></div>
					...
					<div class="footer_nav_container d-flex flex-row align-items-center justify-content-lg-end">
						<div class="footer_nav">
							<ul class="footer_nav_list">
								...
								<li class="footer_nav_item"><a href="resort_profile.php">Profile</a></li>
								<li class="footer_nav_item"><a href="resort_add.php">Add Resort</a></li>
								<li class="footer_nav_item"><a href="admin_approve_requests.php">Approve Requests</a></li>
								<li class="footer_nav_item"><a href="admin_view_rating.php">View Rating</a></li>
								<li class="footer_nav_item"><a href="view_feedback.php">View Feedback</a></li>
