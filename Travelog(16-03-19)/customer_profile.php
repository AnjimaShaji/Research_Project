					...
					<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start" style="    margin-top: -32px;">
						...
						<div class="main_nav_container ml-auto">
							<ul class="main_nav_list">
								...
								<li class="main_nav_item"><a href="cust_search.php">Resorts</a></li>
...
<div class="card">
  ...
  <div class="container">
	...
	<p><b>First Name:</b><?php echo " ".$fetch['r_name'];?></p>
	<p><b>Second Name:</b><?php echo " ".$fetch['r_lname']; ?></p>
	<p><b>Address:</b><?php echo " ".$fetch['r_address'];?></p><tr>
	<p><b>Date of Birth:</b><?php echo " ".$fetch['r_dob'];?></p><tr>
	<p><b>Gender:</b><?php echo " ".$fetch['r_gender'];?></p><tr>
	<p><b>Email:</b><?php echo " ".$fetch['r_email']; ?></p>
	<p><b>Phone:</b><?php echo " ".$fetch['r_phone']; ?></p>
...
button:hover, a:hover {
  opacity: 0.7;
    ...
    <p><a href="customer_edit.php"><button>Edit</button></p>
					...
					<div class="footer_nav_container d-flex flex-row align-items-center justify-content-lg-end">
						<div class="footer_nav">
							...
							<ul class="main_nav_list">
								<li class="main_nav_item"><a href="customer_home.php">home</a></li>
								<li class="main_nav_item"><a href="#">Profile</a></li>
								<li class="main_nav_item"><a href="cust_search.php">Resort</a></li>
