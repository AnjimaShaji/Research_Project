					...
					<div class="footer_nav_container d-flex flex-row align-items-center justify-content-lg-end">
						<div class="footer_nav">
							<ul class="footer_nav_list">
								...
								<li class="footer_nav_item"><a href="admin_add_resort.php">PROFILE</a></li>
								<li class="footer_nav_item"><a href="cust_search.php">RESORT</a></li>
					
								<li class="footer_nav_item"><a href="view_feedback.php">FEEDBACK</a></li>
