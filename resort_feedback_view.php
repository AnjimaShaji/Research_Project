...
$b=$_SESSION['r_id'];
$sql=mysqli_query($con,"SELECT * FROM tbl_login where l_status='1' and r_id='$b'");
...
<div>
<br><h1><font color="green"><center>FEEDBACKS</h1></font>
<?php
include 'dbconnect.php';
...
<?php
	...
	$res=mysqli_query($con,"SELECT * FROM `tbl_feedback` WHERE `r_id`='$a'");
	$i=1;
...
<td><center><?php echo $row['r_id'];?></td>
<td><center><?php echo $row['f_date'];?></td>
<td><center><?php echo $row['f_msg'];?></td>
<td><center><a href="mark_read.php?uid=<?php echo $row['f_id'];?>"><img src="images/DeleteRed.png" width="30px"></a></td></tr>
