...
<form action="resort_uploads.php" method="post" enctype="multipart/form-data">	
Resort Name : <select name="resortnme" onchange="myfunction(this)" id="resort" class="form-control" style="    width: 50%;">	
 <option>--Select Resort--</option>
					...
					?>><?php echo $row['h_name']." ". $row['h_location']; 
